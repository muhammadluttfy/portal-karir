    ...
    <div class="row">
        <div class="col-lg-8">
            <form action="/dashboard/posts/{{ $post->slug }}" method="POST" class="mb-5"
                ...
                <div class="mb-3">
                    <label for="salary" class="form-label">Salary / years</label>
                    <input type="text" class="form-control @error('salary') is-invalid @enderror" name="salary" id="salary"
                        required autofocus value="{{ old('salary', $post->salary) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('salary_source') is-invalid @enderror"
                        name="salary_source" id="salary_source" required autofocus
                        value="{{ old('salary_source', $post->salary_source) }}">
